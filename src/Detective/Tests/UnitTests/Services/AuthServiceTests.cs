...
public class AuthServiceTests
{
    ...
    private readonly Mock<IPasswordProvider> _passwordHasherMock = new();
    private readonly Mock<IEmailService> _emailService = new();
    private readonly Mock<ITwoFactorRepository> _twoFactorRepository = new();
    ...
    public async Task Login_ValidCredentials_ReturnsJwtToken()
    {
        ...
        var user = new User(username: username, password: "hashedPass", type: type, email: "");
