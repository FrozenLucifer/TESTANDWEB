...
public class UserServiceTests
{
    ...
    private readonly Mock<IPasswordProvider> _passwordHasherMock;
    private readonly UserService _userService;

    public UserServiceTests()
    {
        _userRepositoryMock = new Mock<IUserRepository>();
        _passwordHasherMock = new Mock<IPasswordProvider>();
    ...
    public async Task CreateUser_ShouldGeneratePasswordAndCallRepository()
    {
        ...
        _userRepositoryMock.Verify(x => x.CreateUser(username, expectedHash, It.IsAny<string>(), userType), Times.Once);
    ...
    public async Task CreateUser_ShouldThrowUserAlreadyExistsException_WhenUserExists()
    {
        ...
        _userRepositoryMock.Setup(x => x.CreateUser(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<UserType>()))
